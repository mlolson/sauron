...
const empty: Snapshot = { projects: [], sessions: [], orphanTmuxSessions: [], toolPaths: null, worktrees: {}, preferences: { notificationsMuted: false, externalRecentHours: 24 }, loaded: false }
